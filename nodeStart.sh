...
novanetwork --datadir .dag --networkid "87" --rpc.allow-unprotected-txs --nodiscover --maxpeers "1" --syncmode "full" --ipcpath "connect" --mine --miner.threads "1" --miner.etherbase "0x000000000000000000000000000000000000dEaD" 
