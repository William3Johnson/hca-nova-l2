...
novanetwork --datadir .dag --networkid "87" --rpc.allow-unprotected-txs --nodiscover --maxpeers "1" --syncmode "snap" --ipcpath "connect" --mine --miner.etherbase "0x000000000000000000000000000000000000dEaD"
